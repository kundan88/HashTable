...
namespace HashTable
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string Longsentence = "Paranoids are not paranoid because they are paranoid but because they keep putting themselves deliberately into paranoid avoidable situations";
            string[] StringToArray;
            StringToArray = Longsentence.Split(' ');
